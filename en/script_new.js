document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form && statusModal) {
        ...
        form.addEventListener('submit', (e) => {
            e.preventDefault();
            showModal('success', 'Successful!', 'Your application has been received! Our operators will contact you shortly.');
            form.reset();
        });
    ...
    if (hamburgerBtn && navPanel) {
        ...
        // Til tanlanganda kerakli papkaga o'tish
        langDropdown.addEventListener('click', (e) => {
            const link = e.target.closest('a');
            if (link) {
                e.preventDefault(); // Standart xatti-harakatni bekor qilish
                const selectedLang = link.dataset.lang; // 'uz', 'ru', yoki 'en'
                
                // Tanlangan tilning papkasiga to'g'ridan-to'g'ri (absolyut) manzil bo'yicha yo'naltirish
